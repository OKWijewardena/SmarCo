...
<Grid container spacing={2}>
  ...
  <Grid item xs={12} sm={3}>
    <TextField margin="normal"  fullWidth label="emiNumber" value={emiNumber} onChange={e => setemiNumber(e.target.value)}  />
  </Grid>
  <Grid item xs={12} sm={3}>
    <TextField margin="normal"  fullWidth label="customerName" value={customerName} onChange={e => setcustomerName(e.target.value)}  />
  </Grid>
  <Grid item xs={12} sm={3}>
  ...
  <Grid item xs={12} sm={3}>
    <TextField margin="normal"  fullWidth label="months" value={months} onChange={e => setmonths(e.target.value)}/>
  </Grid>
  <Grid item xs={12} sm={3}>
    <TextField margin="normal"  fullWidth label="advance" value={advance} onChange={e => setadvance(e.target.value)}  />
  </Grid>
  <Grid item xs={12} sm={3}>
    <TextField margin="normal"  fullWidth label="balance" value={balance} onChange={e => setbalance(e.target.value)}  />
  </Grid>
...
<Grid item xs={12}>
  <Box sx={{ 
    ...
    <TableContainer component={Paper}sx={{ width: '100%',overflowX: 'auto'  }} >
      ...
      <TableCell style={{ backgroundColor: '#752888', color: 'white' }}>emiNumber </TableCell>
      <TableCell style={{ backgroundColor: '#752888', color: 'white' }}>customerName </TableCell>
      <TableCell style={{ backgroundColor: '#752888', color: 'white' }}>civilID</TableCell>
