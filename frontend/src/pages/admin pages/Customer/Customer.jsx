...
export default function Customer(){
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(`http://http://podsaas.online/api/customer/${id}`);
  ...
  const fetchCustomers = async () => {
    try {
      const response = await axios.get('http://http://podsaas.online/api/customer/');
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      await axios.post('http://http://podsaas.online/api/customer/register', NewCustomer);
      await axios.post('http://http://podsaas.online/api/users/register', NewUser);
