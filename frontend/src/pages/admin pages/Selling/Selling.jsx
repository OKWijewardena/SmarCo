...
sessionStorage.removeItem('token');
  ...
  const handleUpdateSelling = async () => {
    try {
      ...
      const response = await axios.put(
        `http://app.smartco.live/selling/updateSelling/${selectedSelling._id}`, 
        selectedSelling
      );
  ...
  const fetchDeviceDetails = async (emiNumber) => {
    try {
      const response = await axios.get(
        `http://app.smartco.live/device/getOneDevice/${emiNumber}`
      );
  ...
  const fetchCustomerDetails = async (searchTerm) => {
    try {
        const response = await axios.get(
            `http://app.smartco.live/api/customer/search/${searchTerm}`
        );
    ...
    //   try {
    //     const response = await axios.get('http://app.smartco.live/discount/getDiscount');
