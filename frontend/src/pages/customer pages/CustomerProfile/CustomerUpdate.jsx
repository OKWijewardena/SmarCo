...
export default function CustomerUpdate() {
  ...
  //   try {
  //     const res = await axios.get(`https://app.smartco.live/api/customer/${user.email}`);
  ...
  function fetchCustomers() {
    let mounted = true;
    fetch(`https://app.smartco.live/api/customer/${user.email}`)
      .then((res) => res.json())
      .then((result) => {
        console.log(result);
        if (mounted) {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      await axios.put(`https://app.smartco.live/api/customer/${email}`, UpdatedCustomer);
